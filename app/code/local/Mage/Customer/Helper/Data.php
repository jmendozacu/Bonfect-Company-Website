...
class Mage_Customer_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    /**
     * WSDL of ABN validation service
     * 21052018 hao
     */
    const ABN_VALIDATION_WSDL_URL = 'http://abr.business.gov.au/abrxmlsearch/ABRXMLSearch.asmx?WSDL';
    const ABN_VALIDATION_WSDL_GUID = "91ef87d2-cadf-4d41-a74f-b29a024aff90";
    ...
    /**
     * Create SOAP client based on ABN validation service WSDL
     * 21052018 hao
     * @param array $options
     * @return SoapClient
     */
    protected function _createAbnNumberValidationSoapClient($options)
    {
        return new SoapClient(self::ABN_VALIDATION_WSDL_URL, $options);
    }

    /**
    * Create SOAP client based on ABN validation service WSDL provided by Australia CommonWealth
    * 18052018 hao
    * @param string $abn
    * @return bool
    */
    public function AbnNumberValidation($abn){
        ...
        $params = array(
			...
			'authenticationGuid' => self::ABN_VALIDATION_WSDL_GUID,
		);
        try{
            $abnlookup = $this->_createAbnNumberValidationSoapClient($options);
            try{
                $result = $abnlookup->ABRSearchByABN($params);
