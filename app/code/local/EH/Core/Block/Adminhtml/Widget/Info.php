...
class EH_Core_Block_Adminhtml_Widget_Info extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface {
	...
	public function render(Varien_Data_Form_Element_Abstract $element) {
		$html = '<div style="background:url(\'https://www.extensionhut.com/images/logo.png\') no-repeat scroll 40px center #EAF0EE;border:1px solid #CCCCCC;margin-bottom:10px;padding:10px 10px 10px 200px;">
